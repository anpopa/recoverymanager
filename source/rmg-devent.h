 ...
 */
void                    rmg_devent_set_type                 (RmgDEvent *event, 
                                                             DispatcherEventType type);

/**
 * @brief Set dispatcher event service name
 */
void                    rmg_devent_set_service_name         (RmgDEvent *event, const 
                                                             gchar *service_name);

/**
 * @brief Set dispatcher event process name
 */
void                    rmg_devent_set_process_name         (RmgDEvent *event, const 
                                                             gchar *process_name);

/**
 * @brief Set dispatcher event object path
 */
void                    rmg_devent_set_object_path          (RmgDEvent *event, 
                                                             const gchar *object_path);

/**
 * @brief Set dispatcher event context (container) name
 */
void                    rmg_devent_set_context_name         (RmgDEvent *event, 
                                                             const gchar *context_name);

/**
 * @brief Set dispatcher event manager proxy
 */
void                    rmg_devent_set_manager_proxy        (RmgDEvent *event, 
