...
static void rmg_logging_handler (const gchar *log_domain, GLogLevelFlags log_level,
...
void
rmg_logging_open (const gchar *app_name, const gchar *app_desc, const gchar *ctx_name,
...
static void
rmg_logging_handler (const gchar *log_domain, GLogLevelFlags log_level, const gchar *message,
                     gpointer user_data)
{
