...
const gchar *g_action_name[]
    = { "invalid",          "ignoreService",  "resetService",   "resetPublicData",
        "resetPrivateData", "disableService", "contextRestart", "platformRestart",
        "factoryReset",     "guruMeditation" };

/* Preserve the size and order from RmgFriendType */
const gchar *g_friend_name[] = { "unknown", "process", "service", "invalid" };

/* Preserve the size and order from RmgFriendActionType */
const gchar *g_friend_action_name[]
    = { "unknown", "start", "stop", "restart", "signal", "invalid" };
