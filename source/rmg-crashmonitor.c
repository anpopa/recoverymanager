 ...
 */
static gboolean crashmonitor_source_dispatch (GSource *source,
...
crashmonitor_build_proxy (RmgCrashMonitor *crashmonitor)
{
  ...
  if (error != NULL)
    ...
    {
      g_signal_connect (crashmonitor->proxy,
                        "g-signal",
...
{
  RmgCrashMonitor *crashmonitor = (RmgCrashMonitor *)g_source_new (&crashmonitor_source_funcs,
                                                                   sizeof(RmgCrashMonitor));
  ...
  g_source_set_callback (RMG_EVENT_SOURCE (crashmonitor),
                         NULL,
                         crashmonitor,
