 ...
 */
RmgMessage *            rmg_message_new                    (RmgMessageType type,
                                                             uint16_t session);
 ...
 */
void                    rmg_message_set_action_response     (RmgMessage *msg,
                                                             uint64_t action_response);
 ...
 */
void                    rmg_message_set_instance_status     (RmgMessage *msg,
                                                             uint64_t instance_status);
 ...
 */
void                    rmg_message_set_process_name        (RmgMessage *msg,
 ...
 */
void                    rmg_message_set_service_name        (RmgMessage *msg,
 ...
 */
void                    rmg_message_set_context_name        (RmgMessage *msg,
 ...
 */
RmgStatus               rmg_message_read                    (gint fd,
                                                             RmgMessage *msg);
 ...
 * @return RMG_STATUS_OK on success, RMG_STATUS_ERROR otherwise
 */
RmgStatus               rmg_message_write                   (gint fd,
                                                             RmgMessage *msg);
