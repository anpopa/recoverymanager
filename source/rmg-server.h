 ...
 */
RmgServer *             rmg_server_new                      (RmgOptions *options, 
                                                             gpointer dispatcher, 
                                                             GError **error);
 ...
 */
void                    rmg_server_add_client               (RmgServer *server, 
                                                             gpointer client);
 ...
 * @param client Pointer to the client object
 */
void                    rmg_server_rem_client               (RmgServer *server, 
                                                             gpointer client);
 ...
 * @param client Pointer to the client object
 */
gpointer                rmg_server_get_client               (RmgServer *server, 
                                                             const gchar *name);
