...
static RmgRunMode get_run_mode(RmgOptions *options)
{
...
static void dbus_proxy_available_for_checker(gpointer _dbus_proxy, gpointer _checker)
{
...
static void dbus_proxy_available_for_executor(gpointer _dbus_proxy, gpointer _executor)
{
    GDBusProxy *proxy = (GDBusProxy *) _dbus_proxy;
...
RmgApplication *rmg_application_new(const gchar *config, GError **error)
{
    ...
    rmg_monitor_register_proxy_available_callback(
        app->monitor, dbus_proxy_available_for_checker, (gpointer) app->checker);
    rmg_monitor_register_proxy_available_callback(
        app->monitor, dbus_proxy_available_for_executor, (gpointer) app->executor);
