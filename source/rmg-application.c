...
rmg_application_new (const gchar *config, GError **error)
{
  ...
  rmg_monitor_register_proxy_available_callback (app->monitor, dbus_proxy_available_for_checker,
                                                 (gpointer)app->checker);
  rmg_monitor_register_proxy_available_callback (app->monitor, dbus_proxy_available_for_executor,
